...
object DataLoader {
  // 定义数据文件路径
  val PRODUCT_DATA_PATH = "/Users/gangge/ECommerceRecommendSystem/recommender/DataLoader/src/main/resources/products.csv";
  val RATING_DATA_PATH = "/Users/gangge/ECommerceRecommendSystem/recommender/DataLoader/src/main/resources/ratings.csv";
